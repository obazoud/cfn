...
aws cloudformation create-stack --stack-name "network" --parameters ParameterKey="Prefix",ParameterValue="TEST-" --template-url "https://s3-us-west-2.amazonaws.com/nimbusscale-cfn/network.json" --capabilities CAPABILITY_IAM
